...
const PublicTourForm = () => {
  ...
  return (
    <div className="bg-white p-5 rounded-b-2xl  flex flex-col lg:flex-row gap-2 md:gap-5 justify-center items-center md:text-xl text-xs">
      ...
      <div className="md:border-r-2 md:border-t-0 border-t-2 pt-2 md:pt-0 md:pr-4 w-full">
        ...
        <select className="pl-7 w-full text-gray-500 py-2" value={number} onChange={() => { setNumber(event.target.value) }}>
          <option value="choosenumber" >Choose Number</option>
      ...
      <div className="md:border-r-2 md:border-t-0 border-t-2 pt-2 md:pt-0 md:pr-4 w-full">
        ...
        <input value={time} onChange={() => { setTime(event.target.value) }} type="date" placeholder="Choose Date" className="text-gray-500 pl-8 py-2 w-full" />
      </div>
      ...
      <div className="md:border-r-2 md:border-t-0 border-t-2 pt-2 md:pt-0 md:pr-4 w-full">
        ...
        <select className="pl-7 w-full text-gray-500 py-2" value={date} onChange={() => { setDate(event.target.value) }}>
      ...
      <div className="md:border-r-2 md:border-t-0 border-t-2 pt-2 md:pt-0 md:pr-4 w-full">
        ...
        <select className="pl-7 w-full text-gray-500 py-2" value={tour} onChange={() => { setTour(event.target.value) }}>
      ...
      <div className="md:border-r-2 md:border-t-0 border-t-2 pt-2 md:pt-0 md:pr-4 w-full">
        ...
        <select className="pl-7 w-full text-gray-500 py-2" value={transport} onChange={() => { setTransport(event.target.value) }}>
