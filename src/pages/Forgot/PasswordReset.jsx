                ...
                <div className="bg-white p-10 rounded-2xl min-w-96 ">
                    <div >
                        ...
                        <div className="text-center">
                            <Link to={"/"}>
                                <button className="border-2 w-full rounded-full cursor-pointer text-white bg-orange-500 py-2 text-xl mt-4 active:scale-95 hover:bg-transparent hover:text-orange-500 transition-all">Continue</button>
                            </Link>
                        </div>
                    </div>
