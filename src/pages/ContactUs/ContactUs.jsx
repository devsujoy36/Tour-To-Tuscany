            ...
            <div className="bg-orange-300 ">
                <div className="max-w-screen-2xl  lg:mx-auto  lg:py-16 py-20 ">
                    <div className="flex justify-between lg:flex-row flex-col items-center gap-8 md:gap-10 p-10">
                        ...
                        <form onSubmit={hangleSubmit} className="flex flex-col gap-1 w-full text-gray-500 text-lg bg-orange-200 rounded-2xl p-5 lg:p-10 lg:w-1/2">
                            ...
                            <div className="flex justify-center items-center md:mt-5 mt-1">
